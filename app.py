        ...
        match menu:
            case "1":
                ...
                if estoque.adicionar_produto(NewProduto.get_nome(), NewProduto.get_qde(), NewProduto.get_preco()):
                    id = estoque.id_por_nome(NewProduto.get_nome())
                    print("Produto adicionado:")
                    exibir_vetor([id, NewProduto.get_nome(), NewProduto.get_qde(), NewProduto.get_preco()])
            ...
            case "3":
                ...
                if existe:
                    ...
                    if estoque.atualizar_produto(alter_nome, NewProduto.get_id(), NewProduto.get_nome(), NewProduto.get_qde(), NewProduto.get_preco()):
                        ...
                        exibir_vetor([NewProduto.get_id(), NewProduto.get_nome(), NewProduto.get_qde(), NewProduto.get_preco()])
                        input("Aperte Enter para continuar.")
                    else:
